...
int insertar_en_lista_ordenada_sin_duplicados(t_lista*,const t_dato*,t_cmp);
int insertar_en_lista_ordenada_con_duplicados(t_lista*,const t_dato*,t_cmp);
int eliminar_de_lista_ordenada_con_clave(t_lista*,t_dato*,void*,t_cmp);
