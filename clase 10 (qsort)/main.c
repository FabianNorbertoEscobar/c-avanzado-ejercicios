...
int main()
    ...
    printf("\n\n\t\t\t QSORT");
    printf("\n\n Función de la biblioteca stdlib.h");
    ...
    for(i=0;i<10;i++)
        printf("  %d",v1[i]);
    qsort(v1,10,sizeof(int),comparar_int);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("  %d",v1[i]);
    getch();
    ...
    for(i=0;i<10;i++)
        printf("  %.2f",v2[i]);
    qsort(v2,10,sizeof(float),comparar_float);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("  %.2f",v2[i]);
    getch();
    ...
    for(i=0;i<10;i++)
        printf("  %c",v3[i]);
    qsort(v3,10,sizeof(char),comparar_char);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("  %c",v3[i]);
    getch();
    ...
    for(i=0;i<10;i++)
        printf("  %s",v4[i]);
    qsort(v4,10,sizeof(char)*15,comparar_string);
    printf("\n\n Después de ordenar\n");
    for(i=0;i<10;i++)
        printf("  %s",v4[i]);
    getch();
    ...
    qsort(personas,10,sizeof(t_persona),comparar_apellido_personas);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    getch();
    ...
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    qsort(personas,10,sizeof(t_persona),comparar_nombre_personas);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    getch();
    ...
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    qsort(personas,10,sizeof(t_persona),comparar_dni_personas);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    getch();
    ...
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    qsort(personas,10,sizeof(t_persona),comparar_edad_personas);
    printf("\n\n Después de ordenar");
    for(i=0;i<10;i++)
        printf("\n DNI: %d \t Apellido/s: \t %s \n\t\t Nombre/s: \t %s \n\t\t Edad: \t\t %d \n",personas[i].dni,personas[i].apellido,personas[i].nombre,personas[i].edad);
    getch();
